  ...
  return (
    <div className="shadow p-5 flex gap-10 items-center ">
        ...
        <div>
            <button
                type="button"
                className="bg-sky-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shdown-md w-full"
            ...
            <button
                ...
                type="button"
                className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shdown-md w-full mt-2"
            >
